  ...
  return (
    <div className="sm:flex ss:flex-col sm:flex-row mx-auto bg-form-white justify-center items-center ss:h-[100vh] ss:w-full">
      <div className="bg-white h-[70%] md:pt-[1%] ss:w-full md:w-[40%] flex flex-col">
        ...
        <form
          className="w-[70%] flex flex-col space-y-4 pl-[10%]"
        ...
        >
          ...
          <Input
            className="border-[1px] outline-none mb-[6%] h-[30px] focus:ring-1 focus:ring-gray-100"
            value={user.password}
          ...
          <div>
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="terms" onClick={handleRememberMeChange}>
                Remember Me
              </Label>
            </div>
          </div>

          <Button className="w-full self-start mb-3" type="submit">
            Signin
          </Button>
